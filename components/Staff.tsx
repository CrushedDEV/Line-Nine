...
const staffMembers = [
    ...
    { id: '9021', name: 'NEON', role: 'RESIDENT DJ', image: 'https://images.unsplash.com/photo-1521119989659-3f3cfa5d95e0?w=800&q=80' },
                    ...
                    >
                        {staffMembers.map((member, index) => (
                            <motion.div
                                ...
                                className="relative bg-zinc-900 border-t-4 border-neon-green min-w-[280px] md:min-w-[320px] flex-shrink-0 select-none shadow-[0_10px_20px_rgba(0,0,0,0.5)] transform hover:-translate-y-2 transition-transform duration-300"
                            >
                                ...
                                <div className="p-6 bg-zinc-900 relative">
                                    <div className="absolute -top-3 left-6 bg-black text-white px-2 text-xs font-mono border border-neon-green">
                                        ID: {member.id}
                                    </div>
                                    <h3 className="text-2xl font-black uppercase text-white mb-1 tracking-tighter">{member.name}</h3>
